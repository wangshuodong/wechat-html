...
public class AlipayController {
    ...
    @ResponseBody
    public JSONObject queryAlipayBill(String token, String communityId, String roomId, String costType, int pageNum, int pageSize) {
        //支付宝公共请求参数
        ...
        billRequest.setCost_type(costType);
